...
public class Usuario {
    ...
    public String toString() {
        return "Usuario{" + "usu_id_usua=" + usu_id_usua + ", usu_id_perf=" + usu_id_perf + ", usu_nombres=" + usu_nombres + ", usu_apelli1=" + usu_apelli1 + ", usu_apelli2=" + usu_apelli2 + ", usu_dni=" + usu_dni + ", usu_passw=" + usu_passw + ", usu_estado=" + usu_estado + ", usu_fec_esta=" + usu_fec_esta + ", usu_ind_jefe=" + usu_ind_jefe + ", usu_fec_alta=" + usu_fec_alta + ", usu_fec_lic_desde=" + usu_fec_lic_desde + ", usu_fec_lic_hasta=" + usu_fec_lic_hasta + ", usu_conexion=" + usu_conexion + ", usu_fec_bloq=" + usu_fec_bloq + ", usu_hor_bloq=" + usu_hor_bloq + ", usu_tst_creacion=" + usu_tst_creacion + ", usu_tst_modific=" + usu_tst_modific + ", usu_usr_creacion=" + usu_usr_creacion + ", usu_usr_modific=" + usu_usr_modific + '}';
    }
