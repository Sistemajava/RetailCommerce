 ...
 * @author Peter
 */
public class frmPPGComer extends javax.swing.JFrame {

    /**
     * Creates new form frmPPConfig
     */
    public frmPPGComer() {
        initComponents();
    }
    ...
    //    frmUsuario pantallaUsr = new frmUsuario(3);
    //    pantallaUsr.setLocationRelativeTo(null);
    //    pantallaUsr.setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPPGComer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new frmPPGComer().setVisible(true);
        });
    }
