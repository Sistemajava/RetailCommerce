 ...
 * @author Peter
 */
public class frmPPConfig extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPPConfig.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
